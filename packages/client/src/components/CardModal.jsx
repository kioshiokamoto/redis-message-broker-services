...
function CardModal({ name, date, place, department, province, address, badge, cost, role }) {
			...
			<Box borderWidth="1px" borderRadius="lg" overflow="hidden" onClick={onOpen} cursor="pointer" mx="8">
				...
				>
					<Box position="absolute" w="100%" top="3" d="flex" justifyContent="space-between" px="3">
						<Text bg="gray.200" p="1" borderRadius="4">
							s/.{cost}
						</Text>
						{role === 1 && (
							<Flex align="center">
			...
			<Modal isOpen={isOpen} onClose={onClose} isCentered>
				...
				<ModalContent>
					...
					<ModalBody bgGradient="linear(to-t,purple.500, purple.300)">
						<Box color="white">
							<Text fontSize="4xl" align="center" py="5" fontWeight="semibold">
								{name}
							</Text>
							<Box py="4">
