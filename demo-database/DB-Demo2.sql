...
CREATE TABLE GeneroxUsuario(
	...
	idGenero int NOT NULL,
	CONSTRAINT generoxUsuario_Usuario FOREIGN KEY(idUsuario) REFERENCES usuario(idUsuario),
	CONSTRAINT generoxUsuario_Genero FOREIGN KEY(idGenero) REFERENCES genero(idGenero)
);